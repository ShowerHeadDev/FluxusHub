...
function rightClickMenu(sObj)
	...
	currentRightClickMenu = CreateRightClickMenu(
		{"Cut","Copy","Paste Into","Duplicate","Delete","Group","Ungroup","Select Children","Teleport To","Insert Part","Insert Object","Call Function","Call Remote"},
		"",
		false,
		function(option)
			if option == "Cut" then
